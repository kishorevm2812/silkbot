            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or save_crop or view_img:  # Add bbox to image
                        ...
                        if names[c]=="normal" or names[c]=="fugongiya":
                            servo1(10)
                            time.sleep(3)
                            servo1(6)
                            time.sleep(3)
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'kishore_trained.pt', help='model path or triton URL')
